...
const PromptConfirm: React.FC<PromptConfirmProps> = ({
  title,
  description,
  isOpen,
  onClose,
      ...
      <div className="text-center">
        ...
        <div className="flex items-center justify-center w-full gap-3 mt-7">
          <button
            type="button"
            onClick={onClose}
            className="mr-1 px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 dark:bg-gray-600 dark:text-white dark:hover:bg-gray-700"
          >
            {cancelButtonLabel}
          </button>
          <button
            type="button"
            onClick={onAccept}
            className="px-4 py-2 text-sm font-medium text-white rounded-lg bg-red-500 shadow-theme-xs hover:bg-red-600 sm:w-auto"
          >
            {okButtonLabel}
          </button>
        </div>
