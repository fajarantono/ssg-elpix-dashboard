...
export const UserMetaCard: React.FunctionComponent<{ profile: Profile }> = ({
  profile,
}) => {
  const { isOpen, 
    // openModal, 
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          <div className="px-2 pr-14">
            ...
            <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              Update your photp profile to keep your profile up-to-date.
            </p>
          </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div>
                    ...
                    <Input
                      type="text"
                      defaultValue="https://facebook.com/emirhan55"
                    />
                  </div>

                  <div>
                    <Label>X.com</Label>
                    <Input type="text" defaultValue="https://x.com/emirhan55" />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      defaultValue="https://linkedin.com/emirhan55"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      defaultValue="https://instagram.com/emirhan55"
                    />
                  </div>
                </div>
              </div>
