...
const VideoExample: React.FC<{
  ...
  if (!videoUrl) {
    return (
      <div className="w-full h-60 flex items-center justify-center bg-gray-100 dark:bg-gray-700 rounded text-gray-500 dark:text-gray-300 text-center">
    ...
    <div className="relative w-full">
      {loading && (
        <div className="inset-0 flex items-center justify-center bg-gray-100 dark:bg-gray-700 rounded animate-pulse z-10">
          <div className="w-full h-60 bg-gray-300 dark:bg-gray-600 rounded-xl" />
        </div>
      )}
      <video
